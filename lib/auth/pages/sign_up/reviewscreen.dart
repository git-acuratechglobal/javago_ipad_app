                    ...
                    children: [
                          ...
                          Expanded(
                            child: Align(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ref
                                        .read(returnToReviewProvider.notifier)
                                        .update((ref) => true);
                                    final controller =
                                        ref.read(cafePageControllerProvider);
                      ...
                      Row(
                        children: [
                          ...
                          40.horizontalSpace,
                          Text(
                            profile.cafeManagement?.clickAndCollect == 1
                                ? 'Yes'
                                : 'No',
                            style: TextStyle(
                              fontSize: 20.sp,
                      ...
                      Row(
                        children: [
                          ...
                          40.horizontalSpace,
                          Text(
                            profile.cafeManagement!.maxOrdersClickCollect
                                    ?.toString() ??
                                '0',
                            style: TextStyle(
                              fontSize: 20.sp,
