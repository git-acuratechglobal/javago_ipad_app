...
class GetOrderDetails {
    ...
    factory GetOrderDetails.fromJson(Map<String, dynamic> json) => _$GetOrderDetailsFromJson(json);
...
class AddonSize {
    ...
    factory AddonSize.fromJson(Map<String, dynamic> json) => _$AddonSizeFromJson(json);
